...
<main style="color: white; padding-top: 10px; margin: 100px; background-color: #13131a; padding-bottom: 95px;">
        <img src="./images/main-6.png" style="float: left; height: 300px; padding: 50px 100px;">
        <div class="prodname">Colombia Coffee</div><br>
        <div class="prodDesc">Colombia coffee reviews tend to note it as medium-bodied with a rich taste and citrus-like acidity. The best high-grown Colombian coffee typifies the classic Latin American mild, fruity flavor though not the type of fruity taste that seems almost fermented.</div><br><br><br><br>
